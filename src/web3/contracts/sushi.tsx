...
const CONTRACT_SUSHI_ADDR = String(process.env.REACT_APP_CONTRACT_BOND_ADDR).toLowerCase();

const Contract = new Web3Contract(BOND_ABI as Web3ContractAbiItem[], CONTRACT_SUSHI_ADDR, 'BOND');

export const SUSHITokenMeta: TokenMeta = {
  icon: <Icon key="sushi" name="png/sushi" width={40} height={40} />,
  name: 'SUSHI',
  address: CONTRACT_SUSHI_ADDR,
  decimals: 18,
};
